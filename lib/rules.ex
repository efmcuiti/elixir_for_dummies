defmodule IslandsEngine.Rules do
  ...
  def players_set({:call, from}, :show_current_state, state_data) do
  ...
  def player1_turn({:call, from}, :show_current_state, state_data) do
    {:keep_state_and_data, {:reply, from, :player1_turn}}
  end

  def player1_turn({:call, from}, _, state_data) do
    {:keep_state_and_data, {:reply, from, :error}}
  end
  ...
  def player2_turn({:call, from}, :show_current_state, state_data) do
  ...
  def game_over({:call, from}, :show_current_state, state_data) do
